...
public class MerchantDashboardController {
    ...
    @FXML
    private TableView<MerchantDashboardRow> merchantsTable;

    @FXML
    private TableColumn<MerchantDashboardRow, String> nameColoumn;

    @FXML
    private TableColumn<MerchantDashboardRow, String> companyColoumn;

    @FXML
    private TableColumn<MerchantDashboardRow, String> iposIdColoumn;

    @FXML
    private TableColumn<MerchantDashboardRow, String> creditLimitColoumn;

    @FXML
    private TableColumn<MerchantDashboardRow, String> discountPlanColoumn;
    ...
    private MerchantDashboardRow selectedMerchant;
    ...
    private List<MerchantDashboardRow> searchMerchants(String searchText) throws Exception {
        List<MerchantDashboardRow> merchants = new ArrayList<>();
        ...
        try (Connection conn = connectNow.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    merchants.add(new MerchantDashboardRow(
